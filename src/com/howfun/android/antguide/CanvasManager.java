...
public class CanvasManager {
   ...
   public CanvasManager(Context c) {
      ...
      mSoundIds = new int[] {
            mSoundPool.load(mContext, mSoundEffects[SOUND_EFFECT_COLLISION], 1),
            mSoundPool.load(mContext, mSoundEffects[SOUND_EFFECT_VICTORY], 1) };
   ...
   private void checkFoods() {
      if (mFood != null) {
         if (HF2D.checkCollsion(mAnt, mFood)) {
            ...
            mFood.setNewPos();
            mHandler
                  .sendMessage(mHandler.obtainMessage(Utils.MSG_UPDATE_SCORE));
